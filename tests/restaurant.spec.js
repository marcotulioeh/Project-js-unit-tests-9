...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // --------------------------------------------------------------------------------------
    const test1 = createMenu({food:{}, drink:{}}).fetchMenu();
    const test2 = createMenu({dish:{}, craftDrink:{}}).fetchMenu();
    ...
    // --------------------------------------------------------------------------------------
    const restaurant = createMenu({food:{'bolo': 2, 'porção': 10}, drink:{'suco': 5, 'vodka': 70}});
    restaurant.order('coxinha');
    const arr = restaurant.consumption;
    expect(Array.isArray(arr)).toBeTruthy();
    expect(arr[0]).toBe('coxinha');
    ...
    // ```
    // const restaurant = createMenu({food:{'coxinha': 2, 'sopa': 10, 'sashimi': 35}, drink:{'agua': 5}});
    // expect(restaurant.consumption).
